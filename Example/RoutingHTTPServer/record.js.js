...
_showFlashRequiredDialog: function() {
	Recorder.options.flashContainer.innerHTML = '<p>Adobe Flash Player 10.1 or newer is required to use this feature.</p><p><a href='
http: //get.adobe.com/flashplayer' target='_top'>Get it on Adobe.com.</a></p>';
...
if (swfobject == undefined) { /*	SWFObject v2.2 <http://code.google.com/p/swfobject/> is released under the MIT License <http://www.opensource.org/licenses/mit-license.php */
		...
		function u(ai, ag, Y) {
			...
			if (aa) {
				...
				if (M.ie && M.win) {
					...
					aa.outerHTML = '<object classid='
				clsid: D27CDB6E - AE6D - 11cf - 96B8 - 444553540000 '' + ah + '>' + af + '</object>';
					N[N.length] = ai.id;
					X = c(ai.id)
				} else {
					var Z = C(r);
